    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-20">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#6B7D95]">
        ...
        <div className="p-6 rounded-xl border border-[#1A2D44] bg-[#0A1628]/50 space-y-4">
          <div>
            <label className="text-xs font-medium text-[#6B7D95] uppercase tracking-wider">Full Name</label>
            <input
              type="text"
          ...
          <div className="flex items-center gap-2 text-xs text-[#6B7D95]">
        ...
        <p className="text-center text-sm text-[#6B7D95] mt-6">
          ...
          <Link href="/login" className="text-[#00E3FD] hover:underline">
            Sign in
          </Link>
        </p>
